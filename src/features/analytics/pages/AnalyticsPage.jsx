                    ...
                    <div className="flex flex-col items-center gap-3 pt-2">
                        ...
                        <div className="w-full relative group">
                            <Card className="flex items-center justify-between px-6 py-4">
                                ...
                                <span className="font-black text-xl text-white relative z-10">4,205</span>
                            </Card>
                        </div>
                        ...
                        <div className="w-[85%] relative group">
                            <Card className="flex items-center justify-between px-6 py-4">
                                ...
                                <span className="font-black text-xl text-white relative z-10">1,840</span>
                            </Card>
                        </div>
                        ...
                        <div className="w-[60%] relative group">
                            <Card className="flex items-center justify-between px-6 py-4">
                                ...
                                <span className="font-black text-xl text-white relative z-10">620</span>
                            </Card>
                        </div>
                        ...
                        <div className="w-[40%] relative group">
                            <div className="bg-gradient-to-r from-white/[0.15] to-white/[0.05] border border-white/20 rounded-2xl flex items-center justify-between px-6 py-4 shadow-lg hover:border-white/30 transition-all">
                                ...
                                <span className="font-black text-xl text-white relative z-10">214</span>
                            </div>
                        </div>
                    </div>
                </Card>
                ...
                <div className="flex flex-col gap-6">
                    ...
                    <Card className="p-5">
                        <div className="relative z-10">
                            ...
                            <div className="flex items-end gap-4">
                                <span className="text-5xl font-black text-white tracking-tighter">34.5%</span>
                    ...
                    <Card className="p-5 flex-1 flex flex-col justify-center">
                        <div className="relative z-10">
                            ...
                            <div className="flex items-end gap-4">
                                <span className="text-5xl font-black text-white tracking-tighter">18.2</span>
